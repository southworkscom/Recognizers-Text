...
public class TimexFormat {
    ...
    private static String formatDuration(TimexProperty timex) {
        ...
        if (timex.getYears() != null) {
            ...
            timexList.add(TimexHelpers.generateDurationTimex(TimexUnit.Year, 
            		(timex.getYears() != null)? timex.getYears() : BigDecimal.valueOf(Constants.InvalidValue)));
        }
        ...
        if (timex.getMonths() != null) {
            ...
            timexList.add(TimexHelpers.generateDurationTimex(TimexUnit.Month, 
            		(timex.getMonths() != null)? timex.getMonths() : BigDecimal.valueOf(Constants.InvalidValue)));
        }
        ...
        if (timex.getWeeks() != null) {
            ...
            timexList.add(TimexHelpers.generateDurationTimex(TimexUnit.Week, 
            		(timex.getWeeks() != null)? timex.getWeeks() : BigDecimal.valueOf(Constants.InvalidValue)));
        }
        ...
        if (timex.getDays() != null) {
            ...
            timexList.add(TimexHelpers.generateDurationTimex(TimexUnit.Day, 
            		(timex.getDays() != null)? timex.getDays() : BigDecimal.valueOf(Constants.InvalidValue)));
        }
        ...
        if (timex.getHours() != null) {
            ...
            timexList.add(TimexHelpers.generateDurationTimex(TimexUnit.Hour, 
            		(timex.getHours() != null)? timex.getHours() : BigDecimal.valueOf(Constants.InvalidValue)));
        }
        ...
        if (timex.getMinutes() != null) {
            ...
            timexList.add(TimexHelpers.generateDurationTimex(TimexUnit.Minute, 
            		(timex.getMinutes() != null)? timex.getMinutes() : BigDecimal.valueOf(Constants.InvalidValue)));
        }
        ...
        if (timex.getSeconds() != null) {
            ...
            timexList.add(TimexHelpers.generateDurationTimex(TimexUnit.Second, 
            		(timex.getSeconds() != null)? timex.getSeconds() : BigDecimal.valueOf(Constants.InvalidValue)));
        }
    ...
    private static String formatDate(TimexProperty timex) {
    	int year = (timex.getYear() != null)? timex.getYear() : Constants.InvalidValue;
    	int month = (timex.getMonth() != null)? timex.getMonth() : Constants.InvalidValue;
    	int day = (timex.getDayOfWeek() != null)? timex.getDayOfWeek() : (timex.getDayOfMonth() != null)? timex.getDayOfMonth() : Constants.InvalidValue; 
