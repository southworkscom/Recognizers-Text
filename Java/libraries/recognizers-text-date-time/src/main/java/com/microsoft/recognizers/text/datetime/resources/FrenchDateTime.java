...
public class FrenchDateTime {
    ...
    public static final String YearRegex = "\\b(?<year>((1[5-9]|20)\\d{2})|2100)\\b";
    ...
    public static final String DateYearRegex = "(?<year>((1\\d|20)\\d{2})|2100|(([0-27-9]\\d)(?!\\s*\\:)))";
    ...
    public static final Map<String, Long> Numbers = ImmutableMap.<String, Long>builder()
        ...
        .put("vingt-neuf", 29L)
        .put("trente", 30L)
        .put("trente et un", 31L)
        .put("trente-et-un", 31L)
        .put("trente deux", 32L)
        .put("trente-deux", 32L)
        .put("trente trois", 33L)
        .put("trente-trois", 33L)
        .put("trente quatre", 34L)
        .put("trente-quatre", 34L)
        .put("trente cinq", 35L)
        .put("trente-cinq", 35L)
        .put("trente six", 36L)
        ...
        .put("trente-neuf", 39L)
        .put("quarante", 40L)
        .put("quarante et un", 41L)
        .put("quarante-et-un", 41L)
        .put("quarante deux", 42L)
        .put("quarante-duex", 42L)
        .put("quarante trois", 43L)
        .put("quarante-trois", 43L)
        .put("quarante quatre", 44L)
        .put("quarante-quatre", 44L)
        .put("quarante cinq", 45L)
        .put("quarante-cinq", 45L)
        .put("quarante six", 46L)
        .put("quarante-six", 46L)
        .put("quarante sept", 47L)
        .put("quarante-sept", 47L)
        .put("quarante huit", 48L)
        .put("quarante-huit", 48L)
        .put("quarante neuf", 49L)
        .put("quarante-neuf", 49L)
        .put("cinquante", 50L)
        .put("cinquante et un", 51L)
        .put("cinquante-et-un", 51L)
        .put("cinquante deux", 52L)
        .put("cinquante-deux", 52L)
        .put("cinquante trois", 53L)
        .put("cinquante-trois", 53L)
        .put("cinquante quatre", 54L)
        .put("cinquante-quatre", 54L)
        .put("cinquante cinq", 55L)
        .put("cinquante-cinq", 55L)
        .put("cinquante six", 56L)
        .put("cinquante-six", 56L)
        .put("cinquante sept", 57L)
        .put("cinquante-sept", 57L)
        .put("cinquante huit", 58L)
        .put("cinquante-huit", 58L)
        .put("cinquante neuf", 59L)
        .put("cinquante-neuf", 59L)
        .put("soixante", 60L)
        .put("soixante et un", 61L)
        .put("soixante-et-un", 61L)
        .put("soixante deux", 62L)
        .put("soixante-deux", 62L)
        .put("soixante trois", 63L)
        .put("soixante-trois", 63L)
        .put("soixante quatre", 64L)
        .put("soixante-quatre", 64L)
        .put("soixante cinq", 65L)
        .put("soixante-cinq", 65L)
        .put("soixante six", 66L)
        .put("soixante-six", 66L)
        .put("soixante sept", 67L)
        .put("soixante-sept", 67L)
        .put("soixante huit", 68L)
        .put("soixante-huit", 68L)
        .put("soixante neuf", 69L)
        .put("soixante-neuf", 69L)
        .put("soixante dix", 70L)
        .put("soixante-dix", 70L)
        .put("soixante et onze", 71L)
        .put("soixante-et-onze", 71L)
        .put("soixante douze", 72L)
        .put("soixante-douze", 72L)
        .put("soixante treize", 73L)
        .put("soixante-treize", 73L)
        .put("soixante quatorze", 74L)
        .put("soixante-quatorze", 74L)
        .put("soixante quinze", 75L)
        .put("soixante-quinze", 75L)
        .put("soixante seize", 76L)
        .put("soixante-seize", 76L)
        .put("soixante dix sept", 77L)
        .put("soixante-dix-sept", 77L)
        .put("soixante dix huit", 78L)
        .put("soixante-dix-huit", 78L)
        .put("soixante dix neuf", 79L)
        .put("soixante-dix-neuf", 79L)
        .put("quatre vingt", 80L)
        .put("quatre-vingt", 80L)
        .put("quatre vingt un", 81L)
        .put("quatre-vingt-un", 81L)
        .put("quatre vingt deux", 82L)
        .put("quatre-vingt-duex", 82L)
        .put("quatre vingt trois", 83L)
        .put("quatre-vingt-trois", 83L)
        .put("quatre vingt quatre", 84L)
        .put("quatre-vingt-quatre", 84L)
        .put("quatre vingt cinq", 85L)
        .put("quatre-vingt-cinq", 85L)
        .put("quatre vingt six", 86L)
        .put("quatre-vingt-six", 86L)
        .put("quatre vingt sept", 87L)
        .put("quatre-vingt-sept", 87L)
        .put("quatre vingt huit", 88L)
        .put("quatre-vingt-huit", 88L)
        .put("quatre vingt neuf", 89L)
        .put("quatre-vingt-neuf", 89L)
        ...
        .put("quatre-vingt-dix-sept", 97L)
        .put("quatre vingt dix huit", 98L)
        .put("quatre-vingt-dix-huit", 98L)
        .put("quatre vingt dix neuf", 99L)
        .put("quatre-vingt-dix-neuf", 99L)
        .put("cent", 100L)
        .build();
