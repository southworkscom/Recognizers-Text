...
public class EnglishTimeParserConfiguration extends BaseOptionsConfiguration implements ITimeParserConfiguration {
    ...
    public EnglishTimeParserConfiguration(ICommonDateTimeParserConfiguration config) {
        ...
        timeSuffixFull = RegExpUtility.getSafeRegExp(EnglishDateTime.TimeSuffixFull, Pattern.CASE_INSENSITIVE);
        lunchRegex = RegExpUtility.getSafeRegExp(EnglishDateTime.LunchRegex, Pattern.CASE_INSENSITIVE);
        nightRegex = RegExpUtility.getSafeRegExp(EnglishDateTime.NightRegex, Pattern.CASE_INSENSITIVE);
    }
