...
public class EnglishDateTime {
    ...
    public static final String TillRegex = "(?<till>to|till|til|until|thru|through|--|-|—|——|~|–)";

    public static final String RangeConnectorRegex = "(?<and>and|through|to|--|-|—|——|~|–)";

    public static final String RelativeRegex = "(?<order>next|coming|upcoming|this|last|past|previous|current|the)";

    public static final String StrictRelativeRegex = "(?<order>next|coming|upcoming|this|last|past|previous|current)";

    public static final String NextPrefixRegex = "(next|coming|upcoming)\\b";
    ...
    public static final String YearNumRegex = "\\b(?<year>((1[5-9]|20)\\d{2})|2100)\\b";

    public static final String YearRegex = "({YearNumRegex}|{FullTextYearRegex})"
    ...
    public static final String DateUnitRegex = "(?<unit>years|year|months|month|weeks|week|days|day)\\b";
    ...
    public static final String MonthWithYear = "\\b(({WrittenMonthRegex}(\\s*),?(\\s+of)?(\\s*)({YearRegex}|(?<order>next|last|this)\\s+year))|(({YearRegex}|(?<order>next|last|this)\\s+year)(\\s*),?(\\s*){WrittenMonthRegex}))\\b"
            .replace("{WrittenMonthRegex}", WrittenMonthRegex)
            .replace("{YearRegex}", YearRegex);
    ...
    public static final String MonthNumWithYear = "({YearNumRegex}(\\s*)[/\\-\\.](\\s*){MonthNumRegex})|({MonthNumRegex}(\\s*)[/\\-](\\s*){YearNumRegex})"
            .replace("{YearNumRegex}", YearNumRegex)
            .replace("{MonthNumRegex}", MonthNumRegex);

    public static final String WeekOfMonthRegex = "(?<wom>(the\\s+)?(?<cardinal>first|1st|second|2nd|third|3rd|fourth|4th|fifth|5th|last)\\s+week\\s+{MonthSuffixRegex})"
            .replace("{MonthSuffixRegex}", MonthSuffixRegex);

    public static final String WeekOfYearRegex = "(?<woy>(the\\s+)?(?<cardinal>first|1st|second|2nd|third|3rd|fourth|4th|fifth|5th|last)\\s+week(\\s+of)?\\s+({YearRegex}|{RelativeRegex}\\s+year))"
            .replace("{YearRegex}", YearRegex)
            .replace("{RelativeRegex}", RelativeRegex);
    ...
    public static final String QuarterTermRegex = "\\b(((?<cardinal>first|1st|second|2nd|third|3rd|fourth|4th)\\s+quarter)|(Q(?<number>[1-4])))\\b";
    ...
    public static final String QuarterRegexYearFront = "({YearRegex}|{RelativeRegex}\\s+year)\\s+(the\\s+)?{QuarterTermRegex}"
            .replace("{YearRegex}", YearRegex)
            .replace("{RelativeRegex}", RelativeRegex)
            .replace("{QuarterTermRegex}", QuarterTermRegex);
    ...
    public static final String EarlyPrefixRegex = "(?<EarlyPrefix>early|beginning of|start of|(?<RelEarly>earlier(\\s+in)?))";

    public static final String MidPrefixRegex = "(?<MidPrefix>mid|middle of)";

    public static final String LaterPrefixRegex = "(?<LatePrefix>late|end of|(?<RelLate>later(\\s+in)?))";
    ...
    public static final String PrefixDayRegex = "((?<EarlyPrefix>early)|(?<MidPrefix>mid|middle)|(?<LatePrefix>late|later))(\\s+in)?(\\s+the\\s+day)?$";
    ...
    public static final String WeekOfRegex = "(the\\s+)?(week)(\\s+of)";
    ...
    public static final String DateYearRegex = "(?<year>((1\\d|20)\\d{2})|2100|(([0-27-9]\\d)\\b(?!(\\s*((\\:)|{AmDescRegex}|{PmDescRegex})))))"
    ...
    public static final String NextDateRegex = "\\b({NextPrefixRegex}(\\s*week(\\s*,?\\s*on)?)?\\s+{WeekDayRegex})|((on\\s+)?{WeekDayRegex}((\\s+of)?\\s+next\\s*week))\\b"
    ...
    public static final String DateExtractor1 = "\\b((this\\s+)?{WeekDayRegex}\\s*[,-]?\\s*)?(({MonthRegex}(\\.)?\\s*[/\\\\\\.\\-]?\\s*{DayRegex})|(\\({MonthRegex}\\s*[-.]\\s*{DayRegex}\\)))"
            .replace("{WeekDayRegex}", WeekDayRegex)
    ...
    public static final String DateExtractor5 = "\\b{DayRegex}\\s*[/\\\\\\-\\.]\\s*{MonthNumRegex}\\s*[/\\\\\\-\\.]\\s*{DateYearRegex}"
            .replace("{DayRegex}", DayRegex)
            .replace("{MonthNumRegex}", MonthNumRegex)
            .replace("{DateYearRegex}", DateYearRegex);

    public static final String DateExtractor6 = "(?<=\\b(on|in|at)\\s+){MonthNumRegex}[\\-\\.]{DayRegex}\\b"
            .replace("{MonthNumRegex}", MonthNumRegex)
            .replace("{DayRegex}", DayRegex);

    public static final String DateExtractor7 = "\\b{MonthNumRegex}\\s*/\\s*{DayRegex}((\\s+|\\s*,\\s*|\\s+of\\s+){DateYearRegex})?\\b"
            .replace("{MonthNumRegex}", MonthNumRegex)
            .replace("{DayRegex}", DayRegex)
            .replace("{DateYearRegex}", DateYearRegex);

    public static final String DateExtractor8 = "(?<=\\b(on|in|at)\\s+){DayRegex}[\\\\\\-]{MonthNumRegex}\\b"
            .replace("{DayRegex}", DayRegex)
            .replace("{MonthNumRegex}", MonthNumRegex);

    public static final String DateExtractor9 = "\\b{DayRegex}\\s*/\\s*{MonthNumRegex}((\\s+|\\s*,\\s*|\\s+of\\s+){DateYearRegex})?\\b"
            .replace("{DayRegex}", DayRegex)
            .replace("{MonthNumRegex}", MonthNumRegex)
            .replace("{DateYearRegex}", DateYearRegex);
    ...
    public static final String AtRegex = "\\b(((?<=\\bat\\s+)({WrittenTimeRegex}|{HourNumRegex}|{BaseDateTime.HourRegex}(\\s*((?<iam>a)|(?<ipm>p)))?|{MidTimeRegex}))|{MidTimeRegex})\\b"
            .replace("{WrittenTimeRegex}", WrittenTimeRegex)
            .replace("{HourNumRegex}", HourNumRegex)
            .replace("{BaseDateTime.HourRegex}", BaseDateTime.HourRegex)
    ...
    public static final String PureNumFromTo = "((from|between)\\s+)?({HourRegex}|{PeriodHourNumRegex})(\\s*(?<leftDesc>{DescRegex}))?\\s*{TillRegex}\\s*({HourRegex}|{PeriodHourNumRegex})\\s*(?<rightDesc>{PmRegex}|{AmRegex}|{DescRegex})?"
    ...
    public static final String PureNumBetweenAnd = "(between\\s+)({HourRegex}|{PeriodHourNumRegex})(\\s*(?<leftDesc>{DescRegex}))?\\s*{RangeConnectorRegex}\\s*({HourRegex}|{PeriodHourNumRegex})\\s*(?<rightDesc>{PmRegex}|{AmRegex}|{DescRegex})?"
            .replace("{HourRegex}", HourRegex)
            .replace("{PeriodHourNumRegex}", PeriodHourNumRegex)
            .replace("{DescRegex}", DescRegex)
            .replace("{PmRegex}", PmRegex)
    ...
    public static final String SpecificTimeFromTo = "((from|between)\\s+)?(?<time1>({TimeRegex2}|({HourRegex}|{PeriodHourNumRegex})(\\s*(?<leftDesc>{DescRegex}))?))\\s*{TillRegex}\\s*(?<time2>({TimeRegex2}|({HourRegex}|{PeriodHourNumRegex})(\\s*(?<rightDesc>{DescRegex}))?))"
    ...
    public static final String SpecificTimeBetweenAnd = "(between\\s+)(?<time1>({TimeRegex2}|({HourRegex}|{PeriodHourNumRegex})(\\s*(?<leftDesc>{DescRegex}))?))\\s*{RangeConnectorRegex}\\s*(?<time2>({TimeRegex2}|({HourRegex}|{PeriodHourNumRegex})(\\s*(?<rightDesc>{DescRegex}))?))"
            .replace("{TimeRegex2}", TimeRegex2)
            .replace("{RangeConnectorRegex}", RangeConnectorRegex)
            .replace("{HourRegex}", HourRegex)
            .replace("{PeriodHourNumRegex}", PeriodHourNumRegex)
    ...
    public static final String TimeOfDayRegex = "\\b(?<timeOfDay>((((in\\s+(the)?\\s+)?((?<early>early(\\s+|-))|(?<late>late(\\s+|-)))?(morning|afternoon|night|evening)))|(((in\\s+(the)?\\s+)?)(daytime)))s?)\\b";
    ...
    public static final String SimpleTimeOfTodayBeforeRegex = "{DateTimeSpecificTimeOfDayRegex}(\\s*,)?(\\s+(at|around))?\\s*({HourNumRegex}|{BaseDateTime.HourRegex})"
            .replace("{DateTimeSpecificTimeOfDayRegex}", DateTimeSpecificTimeOfDayRegex)
            .replace("{HourNumRegex}", HourNumRegex)
            .replace("{BaseDateTime.HourRegex}", BaseDateTime.HourRegex);
    ...
    public static final String DurationUnitRegex = "(?<unit>years|year|months|month|weeks|week|days|day|hours|hour|hrs|hr|h|minutes|minute|mins|min|seconds|second|secs|sec)\\b";
    ...
    public static final String SetLastRegex = "(?<last>next|upcoming|this|last|past|previous|current)";
    ...
    public static final String HolidayRegex2 = "\\b(?<holiday>all saint's|tree planting day|white lover|st patrick|st george|cinco de mayo|independence|us independence|all hallow|all souls|guy fawkes)(\\s+(of\\s+)?({YearRegex}|{RelativeRegex}\\s+year))?\\b"
            .replace("{YearRegex}", YearRegex)
            .replace("{RelativeRegex}", RelativeRegex);

    public static final String HolidayRegex3 = "(?<holiday>(mlk|martin luther king|martin luther king jr|canberra|easter|columbus|thanks\\s*giving|christmas|xmas|labour|(international|int'l)\\s+workers'?|mother's|mother|mothers|father's|father|fathers|female|single|teacher's|youth|children|arbor|girls|chsmilbuild|lover|labor|inauguration|groundhog|valentine's|baptiste|bastille|halloween|veterans|memorial|mid(-| )autumn|moon|spring|lantern|qingming|dragon boat|new years'|new year's|new year 's|new years|new year)\\s+(day))(\\s+(of\\s+)?({YearRegex}|{RelativeRegex}\\s+year))?"
            .replace("{YearRegex}", YearRegex)
            .replace("{RelativeRegex}", RelativeRegex);
    ...
    public static final String BeforeRegex = "\\b{InclusiveModPrepositions}?(before|in advance of|prior to|(no later|earlier|sooner) than|ending (with|on)|by|till|til|until){InclusiveModPrepositions}?\\b\\s*"
            .replace("{InclusiveModPrepositions}", InclusiveModPrepositions);

    public static final String AfterRegex = "\\b{InclusiveModPrepositions}?(after(?!\\s+or equal to)|(?<!no\\s+)later than){InclusiveModPrepositions}?\\b\\s*"
            .replace("{InclusiveModPrepositions}", InclusiveModPrepositions);

    public static final String SinceRegex = "\\b(since|after or equal to|starting (from|on|with))\\b\\s*";

    public static final String AgoRegex = "\\b(ago|before (?<day>yesterday|today))\\b";
    ...
    public static final String InexactNumberRegex = "\\b(a few|few|some|several|(?<NumTwoTerm>(a\\s+)?couple of))\\b";
    ...
    public static final String ReferenceDatePeriodRegex = "\\b{ReferencePrefixRegex}\\s+(?<duration>week|month|year|weekend)\\b"
    ...
    public static final String ForTheRegex = "\\b(((for the {FlexibleDayRegex})|(on (the\\s+)?{FlexibleDayRegex}(?<=(st|nd|rd|th))))(?<end>\\s*(,|\\.|!|\\?|$)))"
    ...
    public static final String RestOfDateRegex = "\\bRest\\s+(of\\s+)?((the|my|this|current)\\s+)?(?<duration>week|month|year)\\b";
    ...
    public static final String LaterEarlyPeriodRegex = "\\b({PrefixPeriodRegex})\\s+(?<suffix>{OneWordPeriodRegex})\\b"
            .replace("{PrefixPeriodRegex}", PrefixPeriodRegex)
    ...
    public static final String YearAfterRegex = "\\b(or\\s+(above|after))\\b";
    ...
    public static final Map<String, Long> Numbers = ImmutableMap.<String, Long>builder()
        ...
        .put("twenty one", 21L)
        .put("twenty two", 22L)
        .put("twenty three", 23L)
        .put("twenty four", 24L)
        .put("twenty five", 25L)
        .put("twenty six", 26L)
        .put("twenty seven", 27L)
        .put("twenty eight", 28L)
        .put("twenty nine", 29L)
        .put("thirty", 30L)
        .put("thirty one", 31L)
        .put("thirty two", 32L)
        .put("thirty three", 33L)
        .put("thirty four", 34L)
        .put("thirty five", 35L)
        .put("thirty six", 36L)
        .put("thirty seven", 37L)
        .put("thirty eight", 38L)
        .put("thirty nine", 39L)
        .put("forty", 40L)
        .put("forty one", 41L)
        .put("forty two", 42L)
        ...
        .put("seventy one", 71L)
        .put("seventy two", 72L)
        .put("seventy three", 73L)
        .put("seventy four", 74L)
        .put("seventy five", 75L)
        .put("seventy six", 76L)
        .put("seventy seven", 77L)
        .put("seventy eight", 78L)
        .put("seventy nine", 79L)
        .put("eighty", 80L)
        .put("eighty one", 81L)
        .put("eighty two", 82L)
        .put("eighty three", 83L)
        .put("eighty four", 84L)
        .put("eighty five", 85L)
        .put("eighty six", 86L)
        .put("eighty seven", 87L)
        .put("eighty eight", 88L)
        .put("eighty nine", 89L)
        .put("ninety", 90L)
        .put("ninety one", 91L)
        .put("ninety two", 92L)
        .put("ninety three", 93L)
        .put("ninety four", 94L)
        .put("ninety five", 95L)
        .put("ninety six", 96L)
        .put("ninety seven", 97L)
        .put("ninety eight", 98L)
        .put("ninety nine", 99L)
        .put("one hundred", 100L)
        .build();

    public static final Map<String, Long> DayOfMonth = ImmutableMap.<String, Long>builder()
        .put("1st", 1L)
        .put("2nd", 2L)
        .put("3rd", 3L)
        .put("4th", 4L)
    ...
    public static final Map<String, Long> SpecialDecadeCases = ImmutableMap.<String, Long>builder()
        .put("noughties", 2000L)
        .put("two thousands", 2000L)
        .build();

    public static final String DefaultLanguageFallback = "MDY";

    public static final List<String> SuperfluousWordList = Arrays.asList("preferably", "how about", "maybe", "say", "like", "around");
